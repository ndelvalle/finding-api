...
const userProfileRouter  = require('../route/user-profile');
...
class Server {
  ...
  _setupExpressMiddleware() {
    ...
    this.expressApp.request.upload       = (...args) => this.aws.upload(...args);

    this.expressApp.request.jwt = jwt;
  ...
  _setupExpressRoutes() {
    ...
    this.expressApp.use('/role',         jwt.auth, roleRouter);
    this.expressApp.use('/permission',   jwt.auth, permissionRouter);
    this.expressApp.use('/user-profile', jwt.auth, userProfileRouter);
    this.expressApp.use('/organization', jwt.auth, organizationRouter);
