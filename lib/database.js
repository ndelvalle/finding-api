...
const userProfileSchema   = require('../schema/user-profile');
...
class Database {
  ...
  _setupMongooseModels() {
    ...
    this.mongoose.model('UserProfile',   userProfileSchema);
    ...
    this.mongoose.model('Notification',  notificationSchema);
